    ...
    public function index(Request $request): View
    {
        return view('pages.admin', [
            'cards' => [
                ...
                ['title' => __('lexi.admin.dashboard.payments_title'), 'description' => __('lexi.admin.dashboard.payments_description'), 'count' => $this->countLabel('payments', __('lexi.admin.dashboard.payments_suffix')), 'status' => Schema::hasTable('payments') ? __('lexi.admin.dashboard.active') : __('lexi.admin.dashboard.pending'), 'statusClass' => Schema::hasTable('payments') ? 'admin-status--active' : 'admin-status--draft', 'icon' => 'bi-cash-coin', 'href' => route('admin-payments')],
                ['title' => __('lexi.admin.dashboard.usage_title'), 'description' => __('lexi.admin.dashboard.usage_description'), 'count' => $this->countLabel('user_usage', __('lexi.admin.dashboard.usage_suffix')), 'status' => Schema::hasTable('user_usage') ? __('lexi.admin.dashboard.active') : __('lexi.admin.dashboard.pending'), 'statusClass' => Schema::hasTable('user_usage') ? 'admin-status--active' : 'admin-status--draft', 'icon' => 'bi-speedometer2', 'href' => route('admin-usage')],
                ['title' => __('lexi.admin.dashboard.plan_features_title'), 'description' => __('lexi.admin.dashboard.plan_features_description'), 'count' => $this->countLabel('plan_features', __('lexi.admin.dashboard.plan_features_suffix')), 'status' => Schema::hasTable('plan_features') ? __('lexi.admin.dashboard.active') : __('lexi.admin.dashboard.pending'), 'statusClass' => Schema::hasTable('plan_features') ? 'admin-status--active' : 'admin-status--draft', 'icon' => 'bi-sliders2', 'href' => route('admin-plan-features')],
