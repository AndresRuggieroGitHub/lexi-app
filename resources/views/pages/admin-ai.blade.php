@extends('layouts.admin', ['title' => __('lexi.admin.ai.meta_title'), 'description' => __('lexi.admin.ai.meta_description'), 'sidebarNoteTitle' => __('lexi.admin.ai.sidebar_title'), 'sidebarNoteText' => __('lexi.admin.ai.sidebar_text')])

@section('content')
@php
	$generationStatusLabels = [
		'approved' => __('lexi.admin.ai.status_approved'),
		'pending' => __('lexi.admin.ai.status_pending'),
