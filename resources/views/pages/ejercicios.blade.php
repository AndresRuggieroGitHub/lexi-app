...
@php
  ...
  $exerciseRuntimeActiveLocale = strtolower((string) app()->getLocale());
  $exerciseRuntimeFallbacks = [
    'en' => $exerciseRuntimeFallbackTables['en'],
    $exerciseRuntimeActiveLocale => $exerciseRuntimeFallbackTables[$exerciseRuntimeActiveLocale] ?? $exerciseRuntimeFallbackTables['en'],
  ];
@endphp
<script>
(function () {
  ...
  const getUiLocale = () => {
    ...
    const UI_RUNTIME_FALLBACKS = @json($exerciseRuntimeFallbacks);
